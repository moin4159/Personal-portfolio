...
const educationData = [
  {
    id: 1,
    school: "Vishwabharati Academy's College of Engineering.",
    location: "Ahmednagar, MH, India",
    ...
    description:
      "During my time at B.E, I built a strong foundation in computer science, focusing on software development, problem-solving, and real-world applications. Engaging in hands-on projects, internships, and coding challenges enhanced my technical and analytical skills.",
  },
  {
    id: 2,
    school: "Jijamata College Of Science And Arts Bhende",
    location: "Bhende, Maharashtra, India",
