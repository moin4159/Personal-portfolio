...
import STP_CertImg from "@/assets/experience/STP_Cert.jpg";
...
import STP_CertPdf from "@/assets/files/experience_pdf/STP_Cert.pdf";
...
const experiences = [
  {
    ...
    company: "BTPL",
    location: "On-site(Pune, MH, India)",
  ...
  },
  {
    ...
    company: "A2@Z It Hub Pvt Ltd",
    location: "On-site(Ahmednagar, MH, India)",
    period: "Jan 2026 - ful 2026",
    type: "Internship",
